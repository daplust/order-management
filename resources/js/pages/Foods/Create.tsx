...
export default function CreateFood() {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        router.post('/foods', formData, {
            onError: (errors) => {
                setErrors(errors);
                setProcessing(false);
                toast.error('Failed to create food item. Please check the form.');
            },
            onFinish: () => {
                setProcessing(false);
            },
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Add New Food/Beverage" />
            ...
            <div className="space-y-6 p-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold tracking-tight">Create Food Item</h1>
                            <p className="text-muted-foreground">Add a new food or beverage item</p>
                        </div>
                    </div>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex justify-end gap-3 pt-4">
                                ...
                                <Button type="submit" disabled={processing}>
                                    ...
                                    {processing ? 'Creating...' : 'Create Food Item'}
                                </Button>
                            </div>
                        </form>
                    </CardContent>
